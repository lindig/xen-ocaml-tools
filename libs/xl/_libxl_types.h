...
/* autogenerated by 
   ./genwrap.py libxl_types.idl _libxl_types.mli.in _libxl_types.ml.in _libxl_types.h
 */
		...
		if(Is_long(Field(v, 40))) {
			...
			switch(Tag_val(Field(v, 40))) {
			    ...
			    case 2:
			        ...
			        c_val->u.pvh.bootloader = String_option_val(Field(Field(Field(v, 40), 0), 0));
			        libxl_string_list_val(&c_val->u.pvh.bootloader_args, Field(Field(Field(v, 40), 0), 1));
			        timer_mode_val(ctx, &c_val->u.pvh.timer_mode, Field(Field(Field(v, 40), 0), 2));
			        c_val->u.pvh.nested_hvm = Defbool_val(Field(Field(Field(v, 40), 0), 3));
			        c_val->u.pvh.apic = Defbool_val(Field(Field(Field(v, 40), 0), 4));
			        c_val->u.pvh.pvshim = Defbool_val(Field(Field(Field(v, 40), 0), 5));
			        c_val->u.pvh.pvshim_path = String_option_val(Field(Field(Field(v, 40), 0), 6));
			        c_val->u.pvh.pvshim_cmdline = String_option_val(Field(Field(Field(v, 40), 0), 7));
			        c_val->u.pvh.pvshim_extra = String_option_val(Field(Field(Field(v, 40), 0), 8));
			        break;
		    ...
		    case LIBXL_DOMAIN_TYPE_PVH:
		        /* 2: Block */
		        {
			        ...
			        domain_build_info_field = caml_alloc(1,2);
			        {
			        	...
			        	tmp = caml_alloc_tuple(9);
			        
			        	anon_field = Val_string_option(domain_build_info_c->u.pvh.bootloader);
			        	Store_field(tmp, 0, anon_field);
			        
			        	anon_field = Val_string_list(&domain_build_info_c->u.pvh.bootloader_args);
			        	Store_field(tmp, 1, anon_field);
			        
			        	anon_field = Val_timer_mode(domain_build_info_c->u.pvh.timer_mode);
			        	Store_field(tmp, 2, anon_field);
			        
			        	anon_field = Val_defbool(domain_build_info_c->u.pvh.nested_hvm);
			        	Store_field(tmp, 3, anon_field);
			        
			        	anon_field = Val_defbool(domain_build_info_c->u.pvh.apic);
			        	Store_field(tmp, 4, anon_field);
